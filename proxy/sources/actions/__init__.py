...
CANONICAL_ACTION_MAP = {
    ...
    "install_host_agent": "pdv_install",
    "install_client_agent": "pdv_install",
    "uninstall_endpoint_agent": "pdv_uninstall",
    "uninstall_host_agent": "pdv_uninstall",
    "uninstall_client_agent": "pdv_uninstall",
    "update_endpoint_config": "pdv_update_config",
    "update_host_config": "pdv_update_config",
    "update_client_config": "pdv_update_config",
    "update_endpoint_timezone": "pdv_update_timezone",
    "update_host_timezone": "pdv_update_timezone",
    "shutdown_endpoint": "pdv_shutdown",
    "shutdown_host": "pdv_shutdown",
    "test_endpoint_connection": "pdv_test_connection",
    "test_host_connection": "pdv_test_connection",
    "test_endpoint_privilege": "pdv_test_sudo",
    "test_host_privilege": "pdv_test_sudo",
    "refresh_endpoint_printer": "pdv_atualiza_impressora",
    "refresh_host_printer": "pdv_atualiza_impressora",
    "register_endpoints": "pdv_auto_register",
    "register_hosts": "pdv_auto_register",
